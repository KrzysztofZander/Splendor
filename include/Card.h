                ...
                while (enter!=13)
                {
                    ...
                    switch (enter)
                    {
                        case 224:
                                    ...
                                    switch(znak1)
                                        {
                                        case 72:{choose-=1;break;}   // przesuniêcie do góry
                                        case 80: {choose+=1;break;}  // przesuniecie w dól
                                        }
                                ...
                                switch(znak1)
                                    {
                                        ...
                                        case 80:{start-=4;if(start<=0)start+=4;     break;}  // przesuniecie w dól
                                        default: {break;}
                                    }
...
class Table :public Card
{
   ...
   void showCard2()
   {
    ...
    void endTurn()
    {
        if(checkNumberOfCoin(&playerline[0])>10) // Sprawdzenie czy gracz posiada więcej niż 10 żetonów
                        {
